...
public class MovieTableModel extends AbstractTableModel {
    ...
    private static final String[] COLUMN_NAMES = {"Id", "Title", "Publish date", "Description", "Original title", "Actors", "Director", "Duration", "Genre", "Picture path"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch (columnIndex) {
            ...
            case 4:
                return movies.get(rowIndex).getOrigiTitle();
            case 5:
